...
const ContactTeamTel = dbInstance.define(
  "ContactTeamTel",
  {
    code: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
    team_code: { type: DataTypes.INTEGER, allowNull: true, defaultValue: 0 },
  ...
  {
    tableName: "contactteam_tel",
    timestamps: false,
  }
);

export default ContactTeamTel;
